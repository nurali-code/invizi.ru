...
<div id="content">
    <div class="breadcrumbs">
        ...
        <span class="breadcrumbs__current">Видеоотзывы</span>
    </div>

<div class="">
    <h1 class="page_title">Видеоотзывы</h1>
</div>

<div class="page_content video-reviews">
...
<div class="rev_el">
    ...
    <a href="video-review.php" class="title_el"><span style="color:blue;">Современная система</span> пылеудаления – отзыв пользователя</a>
</div>
<div class="rev_el">
	<video controls src="test.mp4"></video>
    <a href="video-review.php" class="title_el"><span style="color:blue;">Современная система</span> пылеудаления – отзыв пользователя</a>
