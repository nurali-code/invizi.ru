...
<div class="">
    <h1 class="page_title">Часто задаваемые вопросы про встроенные пылесосы</h1>
</div>
...
<div>
<a class="faq_title">
Еще одно заблуждение: Встроенный пылесос - рассадник для тараканов?
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 12.3535V10.4004H10.7422V0H12.8906V10.4004H23.584V12.3535H12.8906V23.1934H10.7422V12.3535H0Z" fill="#105BFB"/>
</svg>
</a>
<div class="faq_text">
Cистема встроенного пылеудаления Aertecnica не становится рассадником тараканов и бактерий...
</div>
</div>

<div>
<a class="faq_title">
У меня маленькая квартира, где установить встроенный пылесос?
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 12.3535V10.4004H10.7422V0H12.8906V10.4004H23.584V12.3535H12.8906V23.1934H10.7422V12.3535H0Z" fill="#105BFB"/>
</svg>
</a>
...
<div>
<a class="faq_title">
Беспроводные пылесосы и роботы-пылесосы против встроенных пылесосов Aertecnica
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 12.3535V10.4004H10.7422V0H12.8906V10.4004H23.584V12.3535H12.8906V23.1934H10.7422V12.3535H0Z" fill="#105BFB"/>
</svg>
</a>
